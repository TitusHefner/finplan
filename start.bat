...
:: HOST, PORT, and DANGEROUSLY_DISABLE_HOST_CHECK are set in frontend/.env
start "Frontend" cmd /k "cd /d %~dp0frontend && set PATH=C:\Users\Titus\miniconda3\envs\fin;%PATH% && C:\Users\Titus\miniconda3\envs\fin\node.exe C:\Users\Titus\miniconda3\envs\fin\node_modules\npm\bin\npm-cli.js start"
